...
class __TwigTemplate_4d8e6e1650f765fba1af48192a0dccaa extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1>Modifier l'Activité</h1>
    ...
    <a href=\"";
        ...
        echo "\" class=\"back-to-list\">Retour à la liste</a>
...
{% block title %}Modifier l'Activité{% endblock %}
...
{% block body %}
    ...
    <a href=\"{{ path('app_activite_index') }}\" class=\"back-to-list\">Retour à la liste</a>

    {{ include('activite/_delete_form.html.twig') }}
{% endblock %}

", "activite/edit.html.twig", "C:\\Users\\nahla\\Pidev\\templates\\activite\\edit.html.twig");
    }
}
